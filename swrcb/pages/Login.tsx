      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-transnet-gray">
                Email address
              </label>
              <div className="mt-1">
                <input
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-transnet-gray">
                Password
              </label>
              <div className="mt-1">
                <input
